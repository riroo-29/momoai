...
function buildDefaultMemory() {
  return {
    ...
    character: {
      ...
      voiceStyle:
        "18歳くらいの若い青年の声で話す。泣いている相手をそっと慰めるように、優しく暖かく、静かに寄り添うトーン。低く渋い響きは抑え、声はやわらかく澄んで穏やかに。幼くなりすぎない自然な若さを保ち、威圧感は出さず安心感を最優先する。語尾は丁寧に、やさしく包むように置く。感情は大げさにせず、静かな思いやりをにじませる。",
    },
    facts: [],
  };
}
